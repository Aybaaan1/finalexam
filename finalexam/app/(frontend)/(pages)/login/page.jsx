...
const SignIn = ({ setIsOpen }) => {
  ...
  return (
    <div className="w-full h-screen bg-gray-300">
      <div className="signin-container flex justify-center items-center h-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
              />
            </div>
            <div>
              <label className="block text-gray-700 font-medium mb-2">
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white px-4 py-3 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-[rgb(255,211,70)] transition duration-200"
            >
              Sign In
            </button>
          </form>
